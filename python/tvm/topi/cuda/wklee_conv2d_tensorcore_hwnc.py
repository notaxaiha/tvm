...
def conv2d_hwnc_tensorcore2(data, kernel, strides, padding, dilation, in_dtype, out_dtype='int32'):
...
@autotvm.register_topi_compute("conv2d_HWNCnc_tensorcore2.cuda")
...
@autotvm.register_topi_schedule("conv2d_HWNCnc_tensorcore2.cuda")
def schedule_conv2d_hwnc_tensorcore2(cfg, outs):
